  ...
  return (
    <div>
      ...
      <main className="py-8 px-4 max-w-4xl mx-auto">
        ...
        <h3 className="text-lg font-semibold text-primaryPurple mb-4">Capacidade de Resolução de Problemas</h3>
        <form>
          {/* Question 1 */}
          <div className="mb-8">
            <p className="text-gray-800 mb-2">Eu consigo identificar rapidamente problemas em meu trabalho:</p>
          ...
          {/* Question 2 */}
          <div className="mb-8">
            <p className="text-gray-800 mb-2">Eu penso em várias soluções possíveis antes de tomar um decisão:</p>
            <div className="flex justify-between">
              <label className= "text-gray-800">
          ...
          {/* Question 3 */}
          <div className="mb-8">
            <p className="text-gray-800 mb-2">Eu sou capaz de resolver problemas com autonomia:</p>
            <div className="flex justify-between">
              <label className= "text-gray-800">
                <input type="radio" name="q1" value="nunca" />
                Nunca
          ...
          {/* Question 4 */}
          <div className="mb-8">
            <p className="text-gray-800 mb-2">Eu busco ajuda quando encontro um problema que não consigo resolver:</p>
            <div className="flex justify-between">
              <label className= "text-gray-800">
                <input type="radio" name="q1" value="discordo_fortemente" />
                Discordo fortemente
          ...
          {/* Question 5 */}
          <div className="mb-8">
            <p className="text-gray-800 mb-2">Eu consigo analisar as consequências de  diferentes soluções:</p>
            <div className="flex justify-between">
              <label className= "text-gray-800">
                <input type="radio" name="q1" value="discordo_fortemente" />
                Discordo fortemente
